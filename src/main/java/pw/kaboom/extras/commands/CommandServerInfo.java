...
public final class CommandServerInfo implements BrigadierCommand {
    ...
    static {
        ...
        @Nullable Pair<String[], String> hardwareInfo = Utility.composeCallable(
    ...
    private static final List<InfoEntry> ENTRIES = List.of(
            ...
            new InfoEntry("CPU model", () -> Stream.ofNullable(PROCESSOR_NAME)),
            InfoEntry.of("CPU cores",
                    () -> String.valueOf(Runtime.getRuntime().availableProcessors())),
            InfoEntry.of("CPU load", () -> String.valueOf(OS.getSystemLoadAverage())),
            new InfoEntry("GPU device", () -> Arrays.stream(GPU_DEVICES)),
    ...
    private record InfoEntry(String label, Callable<Stream<String>> values) {
        private static InfoEntry of(String label, Callable<String> value) {
    ...
    private static String uptime() {
        long totalSeconds = RUNTIME.getUptime() / 1000;
